"""Локальный интерфейс: python web_app.py, http://127.0.0.1:8000."""
import argparse
...
def make_server(root=ROOT, port=8000, host='127.0.0.1'):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Локальная страница обработки VMware')
